...
High-performance Kolmogorov-Arnold Network (KAN) in Rust, focused on low-latency inference for poker solvers and other real-time workloads. SIMD-friendly layout, zero allocations on the hot path, ready for baked/quantized models.
...
- Minimal deps: `rayon`, `wide`; no heavy ML frameworks.
...
|-------|------------|-------------|--------------|---------------|---------|
| 1     | ~30 us     | ~0.69 M/s   | ~0.95 ms     | ~0.02 M/s     | Rust ~30x faster (latency) |
